...
/**
 * A {@link BootstrapEnvironment} interface defines all methods which environment implementation should have
 * to be injected into configuration parser during bootstrap.
 */
