 ...
 * TODO:
 * * Open Questions:
 *  * on pipeline right now no new sockets are opened unless others are disconnected?
 * * Handle idle sockets & closing them properly
 * * Migrate endpoint[] to list for selection strategies
 *
 *
